...
- **If you're following the command-line route:** install the **GitHub CLI** (`gh`) as described on the [setup page](setup.qmd#github-desktop)
...
3. Check you're authenticated with GitHub:
   ...
   gh auth status
   ```
   If you get `gh: command not found`, go back to the [setup page](setup.qmd#github-desktop) and install the GitHub CLI first.
...
This exercise is for people who've finished Exercises 1–3 and want to go further. There's no pressure to complete it before the collaborative exercise.
